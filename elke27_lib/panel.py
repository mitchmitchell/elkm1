...
class Panel(Element):
    ...
    def sync(self) -> None:
        """Retrieve panel information from ElkE27"""
    ...
    def _vn_handler(self, elke27_version: str, xep_version: str) -> None:
        self.setattr("elke27_version", elke27_version, False)
