...
from elke27_lib.message import ua_encode
...
class MyApp:
    ...
    def disconnected(self):
        """The ElkE27 panel has disconnect."""
        print("Disconnected!!!")
        exit(0)  # Just exit since this is a demo, might want to try and reconnect.

    def connected(self):
        """The ElkE27 is connected - we can communicate with the panel now!"""
        print("Connected!!!")
    ...
    def sync_complete(self):
        ...
        for your app to sending its own messages to the ElkE27.
        """
        print("Sync complete!!!")
...
def main():
    ...
    url = os.environ.get("ELKE27_URL")
    if not url:
        print("Specify url to connect to in ELKE27_URL environment variable")
        exit(0)
    _ = MyApp(url, 8813)
